...
const payUrl = `${import.meta.env.VITE_BASEURL}pay/aliPay?orderId=${
  route.query.orderId
}&redirect=${redirect}`
...
<template>
  <div class="xtx-pay-page">
    <div class="container">
      <WebShopBread>
        ...
        <WebShopBreadItem>支付订单</WebShopBreadItem>
      </WebShopBread>
      <!-- 付款信息 -->
  ...
  <Teleport>
    <WebShopDialog :title="'正在支付'" v-modle:visible="visibleDialog">
      <div class="pay-wait">
